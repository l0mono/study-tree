...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { book: @study.book, date: @study.date, note: @study.note, page: @study.page, published_at: @study.published_at, time: @study.time } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { book: @study.book, date: @study.date, note: @study.note, page: @study.page, published_at: @study.published_at, time: @study.time } }
